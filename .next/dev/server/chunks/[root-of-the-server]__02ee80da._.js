...
"[project]/app/api/share-data/submit/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const myClaims = claims.filter((c)=>c.Name?.toLowerCase() === Name.trim().toLowerCase() && c.Status?.toLowerCase() === "claimed" && !c.Order_Submitted);
        if (myClaims.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "No unsubmitted claimed items found"
        }, {
            status: 400
        });
        const submittedAt = new Date().toLocaleString("en-US");
        for (const claim of myClaims){
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sheets$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRowInSheet"])("share_claims", claim.__rowIndex, {
                ...claim,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02ee80da._.js.map